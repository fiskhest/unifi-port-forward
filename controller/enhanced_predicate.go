...
// EnhancedServiceChangePredicate replaces the individual predicates with unified change detection
type EnhancedServiceChangePredicate struct{}

func (EnhancedServiceChangePredicate) Update(e event.UpdateEvent) bool {
...
func (EnhancedServiceChangePredicate) Create(e event.CreateEvent) bool {
...
func (EnhancedServiceChangePredicate) Delete(e event.DeleteEvent) bool {
	svc, ok := e.Object.(*corev1.Service)
	if !ok {
		return false
	}
...
func (EnhancedServiceChangePredicate) Generic(e event.GenericEvent) bool {
	return false
}
